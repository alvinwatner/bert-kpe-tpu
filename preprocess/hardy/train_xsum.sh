export DATA_PATH=/home/acp16hh/Projects/Research/Data/Summarization/for_model/xsum/jointkpe/

export dataset_class=xsum # openkp , kp20k
export max_train_steps=40000 #  20810 (openkp) , 73430 (kp20k)
...
CUDA_VISIBLE_DEVICES=0 python train.py --run_mode train \
--local_rank -1 \
...
--pretrain_model_path /home/acp16hh/Projects/Research/Data/Summarization/BBC/intermediary/pretrained \
